# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-04-01 19:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.CharField(max_length=10, unique=True, validators=[django.core.validators.RegexValidator(regex='^[0-9\\-]+$')], verbose_name='part number')),
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=8, verbose_name='price')),
                ('cars', models.ManyToManyField(related_name='parts', to='catalog.Car', verbose_name='vehicles')),
            ],
            options={
                'verbose_name': 'part',
